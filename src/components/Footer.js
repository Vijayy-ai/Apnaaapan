          ...
          <div className="lg:col-span-1">
            ...
            <div className="mb-6 sm:mb-8">
              ...
              <ul className="space-y-2 sm:space-y-3">
                ...
                <li>
                  <a href="/services" className="text-white hover:text-orange-400 transition-colors duration-200 relative group text-sm sm:text-base">
                    Services
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-orange-500 to-yellow-400 transition-all duration-300 group-hover:w-full"></span>
                  </a>
                </li>
           ...
           <div className="lg:col-span-1">
            ...
            <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="text-white text-sm sm:text-base">+91-7611021025</span>
              </div>
              <div className="flex items-center space-x-2 sm:space-x-3">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-white text-sm sm:text-base break-all">info@apnaaapan.com</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {/* WhatsApp */}
              <a href="https://wa.me/917611021025" className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors duration-200">
              ...
              {/* Telegram */}
              <a href="https://t.me/apnaaapan" className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-500 transition-colors duration-200">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Facebook */}
              <a href="https://facebook.com/apnaaapan" className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors duration-200">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
           ...
           <div className="lg:col-span-1">
             ...
             <div className="mb-6 sm:mb-8 text-center sm:text-right">
               <button className="bg-gradient-to-r from-orange-500 to-yellow-400 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl font-semibold text-sm sm:text-base hover:shadow-xl transition-all duration-300 hover:scale-105 shadow-lg w-full sm:w-auto">
                 Book a Call
               </button>
             </div>
